        ...
        public List<SlideData> GetSlides()
        {
            return new List<SlideData>
            {
                new SlideData
                {
                    ...
                    ThumbnailImage = "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80",
                    AltText = "Slide 1"
                },
                new SlideData
                {
                    Id = 2,
                    BackgroundImage = "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80",
